...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__submit_submit_component__ = __webpack_require__("../../../../../src/app/submit/submit.component.ts");
...
AppModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["M" /* NgModule */])({
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_7__submit_submit_component__["a" /* SubmitComponent */],
        ...
        providers: [__WEBPACK_IMPORTED_MODULE_2__public_service__["a" /* PublicService */]],
...
module.exports = "<h4>All existing note will be list below</h4>\n<div *ngIf='showAll'>\n  <div *ngFor='let  n of showAll'>\n    <p>Content:{{ n.note | json }}</p>\n    <p>Created At:{{ n.createdAt | date: 'medium' }}</p>\n\n  </div>\n</div>\n\n<!-- <p>Date:{{note.created_at}}</p> -->\n"
...
var DisplayComponent = (function () {
    function DisplayComponent(_publicService) {
        var _this = this;
        this._publicService = _publicService;
        console.log("hi");
        this._publicService.retrieveAll(function (handle) {
            _this.showAll = handle;
            _this.showAll.reverse();
...
DisplayComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__public_service__["a" /* PublicService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__public_service__["a" /* PublicService */]) === "function" && _a || Object])
], DisplayComponent);
...
var PublicService = (function () {
    ...
    PublicService.prototype.retrieveAll = function (callback) {
        this._http.get("/show").subscribe(function (response) {
    ...
    PublicService.prototype.create = function (input, callback) {
        console.log(typeof (input));
        return this._http.post("/create", input).subscribe(function (response) {
            // console.log( typeOf(input) )
...
module.exports = "<h2>Add a Note</h2>\n\n<p *ngIf='regForm.invalid' [ngStyle]=\"{'color': 'red'}\">Submit button is disabled before quote is entered with minmm length of 4 chatacter</p>\n\n<form (submit)=\"onSubmit()\" #regForm='ngForm' >\n  Note: <input name='note' type=\"text\" required minlength=\"4\" [(ngModel)]=\"inputNote.note\"/>\n  <input class='green' [disabled]='regForm.invalid' type=\"submit\" value=\"Add Note\">\n</form>\n<hr>\n"
...
var SubmitComponent = (function () {
    function SubmitComponent(_publicService) {
        this._publicService = _publicService;
        this.inputNote = {
            note: ''
        };
    ...
    SubmitComponent.prototype.onSubmit = function () {
        ...
        this._publicService.create(this.sendInputeNote, function (handle) {
            console.log('just sent data to service', _this.sendInputeNote);
            _this.inputNote.note = "";
        });
    };
...
SubmitComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["o" /* Component */])({
        selector: 'app-submit',
        template: __webpack_require__("../../../../../src/app/submit/submit.component.html"),
        styles: [__webpack_require__("../../../../../src/app/submit/submit.component.css")]
    }),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__public_service__["a" /* PublicService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__public_service__["a" /* PublicService */]) === "function" && _a || Object])
], SubmitComponent);
